...
let fruitsData: [Fruit] = [
    Fruit(
        ...
        image: "blueberry",
        gradientColor: [Color("ColorBlueberryLight"), Color("ColorBlueberryDark")],
        description: """
    ...
    Fruit(
        ...
        image: "strawberry",
        gradientColor: [Color("ColorStrawberryLight"), Color("ColorStrawberryDark")],
        description: """
    ...
    Fruit(
        ...
        image: "lemon",
        gradientColor: [Color("ColorLemonLight"), Color("ColorLemonDark")],
        description: """
    ...
    Fruit(
        ...
        image: "plum",
        gradientColor: [Color("ColorPlumLight"), Color("ColorPlumDark")],
        description: """
    ...
    Fruit(
        ...
        image: "lime",
        gradientColor: [Color("ColorLimeLight"), Color("ColorLimeDark")],
        description: """
    ...
    Fruit(
        ...
        image: "pomegranate",
        gradientColor: [Color("ColorPomegranateLight"), Color("ColorPomegranateDark")],
        description: """
    ...
    Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "pear",
        gradientColor: [Color("ColorPearLight"), Color("ColorPearDark")],
        description: """
    ...
    Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "gooseberry",
        gradientColor: [Color("ColorGooseberryLight"), Color("ColorGooseberryDark")],
        description: """
    ...
    Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "mango",
        gradientColor: [Color("ColorMangoLight"), Color("ColorMangoDark")],
        description: """
    ...
    Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "watermelon",
        gradientColor: [Color("ColorWatermelonLight"), Color("ColorWatermelonDark")],
        description: """
    ...
    Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "cherry",
        gradientColor: [Color("ColorCherryLight"), Color("ColorCherryDark")],
        description: """
    ...
    Fruit(
        ...
        headline: "Sweet, bell-shaped fruits that have been enjoyed since ancient times. They can be eaten crisp or soft.",
        image: "grapefruit",
        gradientColor: [Color("ColorGrapefruitLight"), Color("ColorGrapefruitDark")],
        description: """
    ...
    Fruit(
        ...
        image: "apple",
        gradientColor: [Color("ColorAppleLight"), Color("ColorAppleDark")],
        description: """
